...
def test_adotb() -> None:
    adotb = Fsm(
        alphabet={Charclass((("a", "a"),)), ~Charclass((("a", "a"), ("b", "b"))), Charclass((("b", "b"),))},
        states={0, 1, 2, 3, 4},
        initial=0,
        finals={4},
        map={
            0: {Charclass((("a", "a"),)): 2, ~Charclass((("a", "a"), ("b", "b"))): 1, Charclass((("b", "b"),)): 1},
            1: {Charclass((("a", "a"),)): 1, ~Charclass((("a", "a"), ("b", "b"))): 1, Charclass((("b", "b"),)): 1},
            2: {Charclass((("a", "a"),)): 3, ~Charclass((("a", "a"), ("b", "b"))): 3, Charclass((("b", "b"),)): 3},
            3: {Charclass((("a", "a"),)): 1, ~Charclass((("a", "a"), ("b", "b"))): 1, Charclass((("b", "b"),)): 4},
            4: {Charclass((("a", "a"),)): 1, ~Charclass((("a", "a"), ("b", "b"))): 1, Charclass((("b", "b"),)): 1},
        },
    )
        ...
        str(
            from_fsm(
                Fsm(
                    ...
                    finals={1},
                    map={
                        0: {Charclass((("0", "0"),)): 1, Charclass((("1", "1"),)): 1, ~Charclass((("0", "0"), ("1", "1"))): 2},
                        1: {Charclass((("0", "0"),)): 2, Charclass((("1", "1"),)): 2, ~Charclass((("0", "0"), ("1", "1"))): 2},
                        2: {Charclass((("0", "0"),)): 2, Charclass((("1", "1"),)): 2, ~Charclass((("0", "0"), ("1", "1"))): 2},
                        3: {Charclass((("0", "0"),)): 0, Charclass((("1", "1"),)): 2, ~Charclass((("0", "0"), ("1", "1"))): 2},
                    },
                )
            )
        )
...
def test_even_star_bug1() -> None:
    ...
    elesscomplex = Fsm(
        ...
        map={
            ...
            1: {Charclass((("a", "a"),)): 0, ~Charclass((("a", "a"),)): 2},
...
def test_base_N() -> None:
    ...
    N = 3
    assert base <= 10
    anything_else = ~Charclass(tuple((str(i), str(i)) for i in range(base)))
    divN = from_fsm(
        Fsm(
            alphabet=({Charclass(((str(i), str(i)),)) for i in range(base)} | {anything_else}),
            ...
            map={
                -2: {
                    Charclass((("0", "0"),)): -1,
                    **{Charclass(((str(j), str(j)),)): j % N for j in range(1, base)},
                    anything_else: N,
                },
                -1: {
                    **{Charclass(((str(j), str(j)),)): N for j in range(base)},
                    anything_else: N,
                },
                **{
                    i: {
                        **{Charclass(((str(j), str(j)),)): (i * base + j) % N for j in range(base)},
                        anything_else: N,
                    }
                    for i in range(N)
                },
...
def test_bug_48_simpler() -> None:
    assert (
        str(
            from_fsm(
                Fsm(
                    alphabet={Charclass((("d", "d"),)), ~Charclass((("d", "d"),))},
                    states={0, 1, 2},
                    initial=0,
                    finals={1},
                    map={
                        0: {Charclass((("d", "d"),)): 1, ~Charclass((("d", "d"),)): 2},
                        1: {Charclass((("d", "d"),)): 2, ~Charclass((("d", "d"),)): 2},
                        2: {Charclass((("d", "d"),)): 2, ~Charclass((("d", "d"),)): 2},
                    },
                )
            )
        )
